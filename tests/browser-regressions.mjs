...
try {
  ...
  await waitFor('Boolean(document.querySelector(".application-result")) || document.body.innerText.includes("Restaurant Health Profile")', 'application submitted')
  console.log('PASS: public routes, owner dashboard, AI report, samples, document preview, funding application')
  await login('admin')
