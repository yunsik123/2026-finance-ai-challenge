...
export const sitePages: SitePage[] = [
  ...
  },
  {
    ...
    audience: 'all', login: 'none',
    purpose: 'AI 추천 식당을 비교하고 상담원과 대화하며 상권 읽을거리를 보는 화면',
    actions: ['추천 식당을 최대 3곳 선택해 성장률·재방문율·기회점수 비교', '오른쪽 상담창에 질문 입력', '추천 질문 칩 클릭', 'AI 오늘의 발견에서 식당 상세 열기', '상권 아티클 자세히 읽기'],
  },
  {
    ...
    actions: ['AI 점주 경영 리포트 확인', '추가 펀딩 준비와 순서별 신청서 작성', '샘플 자료 다운로드와 자료 업로드', '제휴기관 데이터 연결', 'AI 문서 자동 확인', '35개 지표 신용등급 확인', '펀딩 대시보드와 쿠폰 부담 확인', '매장 쿠폰 확인', '투자자 매출 공개 설정'],
  },
  {
    ...
    actions: ['먹투머니 충전', '투자한 식당별 쿠폰 성장 확인', '쿠폰 발급과 1만원 회수', '쿠폰 지갑 상태별 필터', '쿠폰 사용 코드 발급', '쿠폰 지갑에서 교환장 등록', '지난 쿠폰 내역 확인', '관심 식당 다시 보기'],
  },
  {
  ...
  },
  {
    ...
    actions: ['질문 입력', '역할별 추천 질문 클릭', '답변이 참고한 정보 확인'],
  },
  {
...
export const uiTasks: UiTask[] = [
  ...
  },
  {
    ...
    note: '리포트는 연결된 자료에 기반한 참고 해석이며 원인이나 수익을 보장하지 않습니다.',
  },
  {
    id: 'task:owner-dividend', intent: '투자자에게 배당 쿠폰 보내기', pageId: 'page:owner',
    keywords: ['배당쿠폰', '감사쿠폰', '투자자쿠폰', '쿠폰보내'],
    steps: [
      '사장님 센터 대시보드에서 먼저 “쿠폰 손익 안전선”을 확인해요.',
      '“투자자 관계” 카드의 “10% 배당 쿠폰 보내기”를 누르면 현재 투자자에게 쿠폰이 발급됩니다.',
    ],
  ...
  {
    id: 'task:compare-restaurants', intent: 'AI 추천 식당 비교하기', pageId: 'page:insight',
    keywords: ['식당비교', '추천비교', '성장률비교', '재방문율비교', '기회점수비교', '어디투자'],
    steps: [
      '상단 메뉴의 “AI 인사이트”를 클릭해요.',
      'AI 추천 비교 영역에서 비교할 식당을 최대 3곳 선택해요.',
  ...
  {
    id: 'task:credit-grade', intent: '내 신용등급·경영 진단 확인하기', pageId: 'page:owner',
    keywords: ['신용등급', '등급', '내점수', '몇점', '신용평가', '경영진단', '진단', '35개', '지표', '왜이등급'],
    steps: [
      '소상공인 계정으로 로그인한 뒤 상단 메뉴의 “사장님 센터”로 가요.',
      '자료를 올리고 “먹투 자동분석 시작”을 누르면 결과 화면이 나와요.',
      '결과 화면의 “업종 기준 신용등급” 카드에서 등급과 점수, 등급을 올린 지표와 낮춘 지표를 볼 수 있어요.',
