...
export const sitePages: SitePage[] = [
  {
    ...
    actions: ['서비스 작동 방식 확인', '공개 기회점수 상위 식당 보기', '지역·음식 테마 모음 보기', '사장님 안내 배너로 이동'],
  },
  {
  ...
  },
  {
    ...
    actions: ['식당을 최대 3곳 선택해 공개 성장률·재방문율·기회점수 비교', '예시 질문 칩 클릭', '공개정보 한눈에 보기에서 식당 상세 열기', '상권 아티클 자세히 읽기'],
  },
  {
    ...
    actions: ['AI 점주 경영 리포트 확인', '추가 펀딩 준비와 순서별 신청서 작성', '샘플 자료 다운로드와 자료 업로드', '제휴기관 데이터 연결', 'AI 문서 자동 확인', '35개 지표 먹투 성장성 예비평가 확인', '펀딩 대시보드와 쿠폰 부담 확인', '매장 쿠폰 확인', '투자자 매출 공개 설정'],
  },
  {
