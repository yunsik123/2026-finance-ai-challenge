...
export const sitePages: SitePage[] = [
  ...
  },
  {
    ...
    actions: ['위쪽 “쿠폰 교환장” 탭에서 매물 검색·필터', '교환 제안하기 버튼으로 내 쿠폰 제안', '내 교환 탭에서 받은 제안 수락·거절', '위쪽 “펀드 예약 거래” 탭에서 투자 대기·회수 대기 줄 확인', '내 예약 주문 취소'],
  },
  {
  ...
  },
  {
    ...
    audience: 'all', login: 'none',
    purpose: '식당 예비점수가 어떤 근거로 계산됐는지, 신용평가 모델이 어떤 지표를 쓰는지 공개하는 화면',
    actions: ['분석할 식당 선택', '점수 구성요소와 가중치 확인', '주소 기반 상권 분석 확인', '투자자 확인 절차 보기', '35개 지표 신용평가 모델과 참고 연구 확인'],
  },
  {
    ...
    actions: ['펀딩 신청서 작성과 자료 업로드', '제휴기관 데이터 연결', 'AI 문서 자동 확인', '35개 지표 신용등급 확인', '펀딩 대시보드와 쿠폰 부담 확인', '매장 쿠폰 확인', '투자자 매출 공개 설정'],
  },
  {
  ...
  {
    id: 'page:support', name: '1:1 문의', route: '/support', menuPath: '화면 맨 아래 푸터 > 도움말 > 1:1 문의',
    audience: 'all', login: 'none',
  ...
  },
  {
    ...
    actions: ['로그인 탭에서 이메일·비밀번호 입력', '회원가입 탭에서 투자자 또는 소상공인 역할 선택', '“😋 투자자로 체험하기”·“👩‍🍳 사장님으로 체험하기” 버튼으로 체험 시작'],
  },
]
...
export const uiTasks: UiTask[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      '저장 없이 둘러보려면 로그인 탭 아래 “😋 투자자로 체험하기” 또는 “👩‍🍳 사장님으로 체험하기”를 누르세요.',
    ],
