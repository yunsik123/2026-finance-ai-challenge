...
export function createSeed(ownerHash: string, investorHash: string): Database {
  return {
    ...
    coupons: [
      ...
      { id: 'c-market-3', userId: 'u-owner', restaurantId: 'r-dotori', fundId: 'f-dotori', title: '도토리분식 28% 쿠폰', discount: 28, maxDiscountWon: 4480, type: 'fund', status: 'listed', expiresAt: day(48), createdAt: day(-8) },
      { id: 'c-market-4', userId: 'u-owner', restaurantId: 'r-oven', fundId: 'f-oven', title: '오후의 오븐 32% 쿠폰', discount: 32, maxDiscountWon: 11520, type: 'dividend', status: 'listed', expiresAt: day(67), createdAt: day(-3) },
      { id: 'c-market-5', userId: 'u-owner', restaurantId: 'r-greenbowl', fundId: 'f-greenbowl', title: '그린볼 클럽 22% 쿠폰', discount: 22, maxDiscountWon: 4180, type: 'fund', status: 'listed', expiresAt: day(72), createdAt: day(-9) },
      { id: 'c-market-6', userId: 'u-owner', restaurantId: 'r-sunmandu', fundId: 'f-sunmandu', title: '선만두 30% 쿠폰', discount: 30, maxDiscountWon: 8100, type: 'dividend', status: 'listed', expiresAt: day(81), createdAt: day(-5) },
    ],
    couponListings: [
      { id: 'cl-1', userId: 'u-owner', couponId: 'c-market-1', wantedCategory: '한식', wantedRegion: '서울', status: 'open', createdAt: day(-2) },
      { id: 'cl-2', userId: 'u-owner', couponId: 'c-market-2', wantedCategory: '베이커리', wantedRegion: '대전', status: 'open', createdAt: day(-3) },
      { id: 'cl-3', userId: 'u-owner', couponId: 'c-market-3', wantedCategory: '카페', wantedRegion: '서울', status: 'open', createdAt: day(-4) },
      { id: 'cl-4', userId: 'u-owner', couponId: 'c-market-4', wantedCategory: '한식', wantedRegion: '수원', status: 'open', createdAt: day(-1) },
      { id: 'cl-5', userId: 'u-owner', couponId: 'c-market-5', wantedCategory: '세계음식', wantedRegion: '서울', status: 'open', createdAt: day(-5) },
      { id: 'cl-6', userId: 'u-owner', couponId: 'c-market-6', wantedCategory: '일식', wantedRegion: '부산', status: 'open', createdAt: day(-2.5) },
    ],
    applications: [],
    reviews,
    visitVerifications: [],
